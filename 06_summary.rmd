...
knitr::opts_chunk$set(echo = TRUE, warning = TRUE, message = FALSE, time_it = TRUE, cache.extra = "monkey")
```
...
make_summary <- function(data, measures = c("dbh", "ht_p", "density", "ba", "sdi")) {
  data %>%
