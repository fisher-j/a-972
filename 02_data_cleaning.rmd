...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE, time_it = TRUE, cache.extra = "monkey")
```
...
dbh_problem1 %>%
  ...
  kableExtra::column_spec(3, background = dbh_color[[1]]) %>%
  kableExtra::column_spec(4, background = dbh_color[[2]]) %>%
  kableExtra::column_spec(5, background = dbh_color[[3]]) %>%
  kableExtra::column_spec(12, background = outlier_color[[1]]) %>%
  kableExtra::column_spec(13, background = outlier_color[[2]])
```
