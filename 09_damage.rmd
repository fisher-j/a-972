...
1. It could be modeled as binary data with a zero-inflated genearlized linear model binomial regression with logit link (logistic regression). This, I think would 

2. Another approach is modeling percent bear damage at the plot level.
