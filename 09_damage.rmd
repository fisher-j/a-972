...
dam_bar1(wd, bs_cum, type = "pct", "Cumulative percent of all trees with broken stems")
dam_bar1(wd, wt_cum, type = "pct", "Cumulative percent of all uprooted trees")

wd |>
  filter(spp %in% c("SESE3", "PSMEM")) |>
  dam_bar1(bt_cum, type = "pct", "Cumulative percent of DF and RW trees with broken tops for RW & DF")
