...
What about for multiple species?
...
bdmd <- subset(bd, year %in% c("13", "18") & spp %in% c("SESE3", "PSMEM"))
...
```{r}
bm2 <- glmer(bear_new ~ treatment + year + d_inc2 + spp + (1 | plot), family = binomial, data = bdmd)
