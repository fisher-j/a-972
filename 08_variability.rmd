...
```{r 08-variability-20, fig.height=3.5, fig.width=3.5}
...
Error bars represent 1 SE of emmean. This figure includes only shrub cover.
...
```{r 08-variability-23, fig.width=3.5, fig.height=4}
veg <- bind_rows(
