...
I think what I need to do is just look at 2018 and show the total percent cover and dominant species in the same barplot. This plot shows average shrub cover for each treatment with the weighted dominant species at each plot, or more simply, just the most prevalent dominant species.
...
veg_cover %>%
  ...
  ggplot(aes(treatment, fill = dom_shrub)) +
    ...
    scale_fill_grey() +
    labs(caption = "one bar for each treatment, indicating average percent cover and a scaled representation of dominant species from each of the 4 plots")
