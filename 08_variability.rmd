...
Mean directional index is described slightly differently by @corral-rivasPermutationTestSpatial2010 and @pommereningReconstructingSpatialTree2008 but I believe that they are equivalent representations. I'm using the latter with four:
...
This index calculates tree species diversity based on the number of stems and basal area.
...
It is hard to say because sword fern are treated (mostly) as herbs for the first two entries, and then as shrubs for the last, but even this is inconsistant, some third entries have sword fern listed as an herb.
...
change in percent cover of shrubs and herbs over time for each treatment
